    ...
    def __init__(
        ...
        **kwargs
        ...
        self.ws = BfxWebsocket(
            ...
            create_event_emitter=create_event_emitter,
            *args,
            **kwargs
        )
        self.rest = BfxRest(API_KEY=API_KEY, API_SECRET=API_SECRET, host=rest_host, logLevel=logLevel, *args, **kwargs)
